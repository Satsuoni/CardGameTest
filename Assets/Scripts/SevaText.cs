...
using System;
[ExecuteInEditMode]
[AddComponentMenu("UI/SevaText", 10)]
public class SevaText : Graphic 
{
	public float mulmul=1;
		...
		public float pixelsPerUnit
		{
			get
			{
				...
				if (!font || font.dynamic)
					return localCanvas.scaleFactor*mulmul;
				...
				if (m_FontData.fontSize <= 0 || font.fontSize <= 0)
					return 1;
				return font.fontSize*mulmul/ (float)m_FontData.fontSize;
			}
		}
